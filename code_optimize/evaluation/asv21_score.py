...
def discover_prediction_files(
    ...
    if not deduped:
        raise FileNotFoundError(f"No ASV21 prediction csv files selected under {results_dir}.")
    return deduped
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Prediction csv to score. Repeat this option for multiple files; "
            "omit it to scan the directory."
        ),
    )
